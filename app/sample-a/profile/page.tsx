...
export default function ProfilePageA() {
  ...
  const inputCls =
    'w-full px-2.5 py-1.5 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-400 bg-white';

  return (
    <AppShellA breadcrumbs={[{ label: t('nav_profile') }]}>
      <div className="p-6 max-w-lg mx-auto">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          {/* Header */}
          <div className="bg-indigo-50 px-6 py-5 flex items-center gap-4 border-b border-slate-200">
            <div className="w-14 h-14 rounded-full bg-indigo-100 text-indigo-700 flex items-center justify-center text-xl font-black select-none">
